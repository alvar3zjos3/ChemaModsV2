...
ChemaModsV2's chat translation feature relies on LibreTranslate. This guide will help you setup LibreTranslate translation service on your computer.
...
When the console outputs `Running on http://*:5000`, it means LibreTranslate has successfully run on port 5000. You can now turn on the chat translation switch in ChemaModsV2 and configure the target language.
...
This document only lists the most likely parameters to be used as the backend service for ChemaModsV2 chat translation.
...
**If you change the listening port of LibreTranslate, please fill in the same port in the URL setting of ChemaModsV2 chat translation settings.**
