...
namespace big
{
	translation_service::translation_service() :
	    m_url("https://raw.githubusercontent.com/alvar3zjos3/ChemaModsV2-Traducciones/master"),
	    m_fallback_url("https://cdn.jsdelivr.net/gh/alvar3zjos3/ChemaModsV2-Traducciones@master")
	{
	}
