...
namespace big
{
	constexpr const static auto apartment_names = std::to_array({
	    ...
	    "Lombank West",
	    "Maze Bank West",
	    "Centro de Negocios Arcadius",
	    "Torre Maze Bank",
	    "Clubhouse Rancho",
	    "Clubhouse Playa Del Perro",
	    "Clubhouse Pillbox Hill",
	    "Clubhouse Great Chaparral",
	    "Clubhouse Paleto Bay",
	    "Clubhouse Sandy Shores",
	    "Clubhouse La Mesa",
	    "Clubhouse Downtown Vinewood",
	    "Clubhouse Hawick",
	    "Clubhouse Grapeseed",
	    "Clubhouse Paleto Bay",
	    "Clubhouse Playa Vespucci",
	    "Garaje de Oficina 1",
	    "Garaje de Oficina 2",
	    "Garaje de Oficina 3",
	    "Garaje de Oficina 1",
