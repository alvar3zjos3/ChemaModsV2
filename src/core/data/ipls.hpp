...
// gracias a https://github.com/DurtyFree/gta-v-data-dumps
const ipl_libary ipls[] = {
    ...
    }, // North Yankton
    {
        ...
        {{""}},
        {{""}},
    }, // Cayo Perico (No cargar interiores)
    {
        "Yate de Fiesta Dignity", 
        {-2045.8, -1031.2, 11.9}, 
    ...
    {
        "Barco de Carga Hundido",
        {-162.89, -2365.76, 0.0},
        {{"sunk_ship_fire"}, {"sunkcargoship"}},
        {{"cargoship"}},
        {{"cargoship"}},
    }, // Barco de Carga Hundido (atraco de Merryweather)
    {
        "Hospital Pillbox Destruido", 
        {297.84, -584.41, 43.26}, 
    ...
    {
        "Interior de la Morgue del Forense", 
        {244.9, -1374.7, 39.5},
