...
namespace big
{
	...
	public:
		...
		struct reactions
		{
			reaction bounty{"BOUNTY", "REACCIÓN_RECOMPENSA_NOTIFICAR", "REACCIÓN_RECOMPENSA_ANUNCIAR"};
			reaction break_game{"BREAK_GAME", "REACCIÓN_ROMPER_JUEGO_NOTIFICAR", "REACCIÓN_ROMPER_JUEGO_ANUNCIAR"};
			reaction ceo_kick{"CEO_KICK", "REACCIÓN_EXPULSIÓN_CEO_NOTIFICAR", "REACCIÓN_EXPULSIÓN_CEO_ANUNCIAR"};
			reaction ceo_money{"CEO_MONEY", "REACCIÓN_DINERO_CEO_NOTIFICAR", "REACCIÓN_DINERO_CEO_ANUNCIAR"};
			reaction clear_wanted_level{"CLEAR_WANTED_LEVEL", "REACCIÓN_LIMPIAR_NIVEL_BUSCADO_NOTIFICAR", "REACCIÓN_LIMPIAR_NIVEL_BUSCADO_ANUNCIAR"};
			reaction crash{"CRASH", "REACCIÓN_CRASH_NOTIFICAR", "REACCIÓN_CRASH_ANUNCIAR"};
			reaction delete_vehicle{"DELETE_VEHICLE", "REACCIÓN_BORRAR_VEHICULO_NOTIFICAR", "REACCIÓN_BORRAR_VEHICULO_ANUNCIAR"};
			reaction fake_deposit{"FAKE_DEPOSIT", "REACCIÓN_DEPÓSITO_FALSO_NOTIFICAR", "REACCIÓN_DEPÓSITO_FALSO_ANUNCIAR"};
			reaction force_mission{"FORCE_MISSION", "REACCIÓN_FORZAR_MISIÓN_NOTIFICAR", "REACCIÓN_FORZAR_MISIÓN_ANUNCIAR"};
			reaction force_teleport{"FORCE_TELEPORT", "REACCIÓN_FORZAR_TELETRANSPORTE_NOTIFICAR", "REACCIÓN_FORZAR_TELETRANSPORTE_ANUNCIAR"};
			reaction gta_banner{"GTA_BANNER", "REACCIÓN_BANNER_GTA_NOTIFICAR", "REACCIÓN_BANNER_GTA_ANUNCIAR"};
			reaction kick{"KICKS", "REACCIÓN_EXPULSIÓN_NOTIFICAR", "REACCIÓN_EXPULSIÓN_GENÉRICA_ANUNCIAR"};
			reaction kick_from_interior{"KICK_FROM_INTERIOR", "REACCIÓN_EXPULSIÓN_DEL_INTERIOR_NOTIFICAR", "REACCIÓN_EXPULSIÓN_DEL_INTERIOR_ANUNCIAR"};
			reaction mc_teleport{"MC_TELEPORT", "REACCIÓN_TELETRANSPORTE_MC_NOTIFICAR", "REACCIÓN_TELETRANSPORTE_MC_ANUNCIAR"};
			reaction personal_vehicle_destroyed{"PERSONAL_VEHICLE_DESTROYED", "REACCIÓN_VEHICULO_PERSONAL_DESTRUIDO_NOTIFICAR", "REACCIÓN_VEHICULO_PERSONAL_DESTRUIDO_ANUNCIAR"};
			reaction remote_off_radar{"REMOTE_OFF_RADAR", "REACCIÓN_OFF_RADAR_NOTIFICAR", "REACCIÓN_OFF_RADAR_ANUNCIAR"};
			reaction rotate_cam{"ROTATE_CAM", "REACCIÓN_ROTAR_CAMARA_NOTIFICAR", "REACCIÓN_ROTAR_CAMARA_ANUNCIAR"};
			reaction send_to_cutscene{"SEND_TO_CUTSCENE", "REACCIÓN_ENVIAR_A_CINEMÁTICA_NOTIFICAR", "REACCIÓN_ENVIAR_A_CINEMÁTICA_ANUNCIAR"};
			reaction send_to_location{"SEND_TO_LOCATION", "REACCIÓN_ENVIAR_A_UBICACIÓN_NOTIFICAR", "REACCIÓN_ENVIAR_A_UBICACIÓN_ANUNCIAR"};
			reaction send_to_interior{"TP_TO_INTERIOR", "REACCIÓN_ENVIAR_AL_INTERIOR_NOTIFICAR", "REACCIÓN_ENVIAR_AL_INTERIOR_ANUNCIAR"};
			reaction sound_spam{"SOUND_SPAM", "REACCIÓN_SPAM_SONIDO_NOTIFICAR", "REACCIÓN_SPAM_SONIDO_ANUNCIAR"};
			reaction spectate_notification{"SPECTATE_NOTIFICATION", "REACCIÓN_NOTIFICACIÓN_ESPECTADOR_NOTIFICAR", "REACCIÓN_NOTIFICACIÓN_ESPECTADOR_ANUNCIAR"};
			reaction give_collectible{"GIVE_COLLECTIBLE", "REACCIÓN_DAR_OBJETO_COLECCIONABLE_NOTIFICAR", "REACCIÓN_DAR_OBJETO_COLECCIONABLE_ANUNCIAR"};
			reaction transaction_error{"SHOW_TRANSACTION_ERROR", "REACCIÓN_ERROR_TRANSACCIÓN_NOTIFICAR", "REACCIÓN_ERROR_TRANSACCIÓN_ANUNCIAR"};
			reaction tse_freeze{"TSE_FREEZE", "REACCIÓN_CONGELACIÓN_TSE_NOTIFICAR", "REACCIÓN_CONGELACIÓN_TSE_ANUNCIAR"};
			reaction tse_sender_mismatch{"TSE_SENDER_MISMATCH", "REACCIÓN_DESAJUSTE_EMISOR_TSE_NOTIFICAR", "REACCIÓN_DESAJUSTE_EMISOR_TSE_ANUNCIAR"};
			reaction vehicle_kick{"VEHICLE_KICK", "REACCIÓN_EXPULSIÓN_VEHICULO_NOTIFICAR", "REACCIÓN_EXPULSIÓN_VEHICULO_ANUNCIAR"};
			reaction teleport_to_warehouse{"TELEPORT_TO_WAREHOUSE", "REACCIÓN_TELETRANSPORTE_A_ALMACÉN_NOTIFICAR", "REACCIÓN_TELETRANSPORTE_A_ALMACÉN_ANUNCIAR"};
			reaction start_activity{"START_ACTIVITY", "REACCIÓN_INICIAR_ACTIVIDAD_NOTIFICAR", "REACCIÓN_INICIAR_ACTIVIDAD_ANUNCIAR"};
			reaction start_script{"START_SCRIPT", "REACCIÓN_INICIAR_SCRIPT_NOTIFICAR", "REACCIÓN_INICIAR_SCRIPT_ANUNCIAR"};
			reaction destroy_personal_vehicle{"DESTROY_PERSONAL_VEHICLE", "REACCIÓN_DESTRUIR_VEHICULO_PERSONAL_NOTIFICAR", "REACCIÓN_DESTRUIR_VEHICULO_PERSONAL_ANUNCIAR"};
			reaction trigger_business_raid{"TRIGGER_BUSINESS_RAID", "REACCIÓN_ACTIVAR_ATAQUE_NEGOCIO_NOTIFICAR", "REACCIÓN_ACTIVAR_ATAQUE_NEGOCIO_ANUNCIAR"};
			reaction turn_into_beast{"TURN_INTO_BEAST", "REACCIÓN_CONVERTIR_EN_BESTIA_NOTIFICAR", "REACCIÓN_CONVERTIR_EN_BESTIA_ANUNCIAR"};
			reaction remote_wanted_level{"WANTED_LEVEL", "REACCIÓN_NIVEL_BUSCADO_NOTIFICAR", "REACCIÓN_NIVEL_BUSCADO_ANUNCIAR"};
			interloper_reaction remote_wanted_level_others{"WANTED_LEVEL_ON_OTHERS", "REACCIÓN_NIVEL_BUSCADO_EN_OTROS_NOTIFICAR", "REACCIÓN_NIVEL_BUSCADO_EN_OTROS_ANUNCIAR", false, false};

			reaction clear_ped_tasks{"CLEAR_PED_TASKS", "REACCIÓN_LIMPIAR_TAREAS_PED_NOTIFICAR", "REACCIÓN_LIMPIAR_TAREAS_PED_ANUNCIAR"};
			reaction remote_ragdoll{"REMOTE_RAGDOLL", "REACCIÓN_MUÑECO_DE_TRAPO_NOTIFICAR", "REACCIÓN_MUÑECO_DE_TRAPO_ANUNCIAR"};
			reaction kick_vote{"VOTE_KICK", "REACCIÓN_VOTACIÓN_EXPULSIÓN_NOTIFICAR", "REACCIÓN_VOTACIÓN_EXPULSIÓN_ANUNCIAR"};
			reaction report_cash_spawn{"CASH_SPAWN", "REACCIÓN_APARICIÓN_DINERO_NOTIFICAR", "REACCIÓN_APARICIÓN_DINERO_NOTIFICAR"};
			reaction modder_detection{"MODDER_DETECTION", "REACCIÓN_MODDER_DETECTADO_NOTIFICAR", "REACCIÓN_MODDER_DETECTADO_NOTIFICAR"};
			reaction game_anti_cheat_modder_detection{"GAME_ANTICHEAT_DETECTION", "REACCIÓN_MODDER_DETECTADO_POR_ANTICHEAT_NOTIFICAR", "REACCIÓN_MODDER_DETECTADO_POR_ANTICHEAT_NOTIFICAR"};
			reaction request_control_event{"REQUEST_CONTROL_EVENT", "REACCIÓN_SOLICITUD_CONTROL_NOTIFICAR", "REACCIÓN_SOLICITUD_CONTROL_ANUNCIAR"};
			reaction report{"REPORT", "REACCIÓN_REPORTE_NOTIFICAR", "REACCIÓN_REPORTE_ANUNCIAR"};
			reaction chat_spam{"CHAT_SPAM", "REACCIÓN_SPAM_CHAT_NOTIFICAR", "REACCIÓN_SPAM_CHAT_ANUNCIAR"};
			reaction spectate{"SPECTATE", "REACCIÓN_ESPECTANDO_NOTIFICAR", "REACCIÓN_ESPECTANDO_ANUNCIAR"};
			interloper_reaction spectate_others{"SPECTATE_OTHERS", "REACCIÓN_ESPECTANDO_A_OTROS_NOTIFICAR", "REACCIÓN_ESPECTANDO_A_OTROS_ANUNCIAR", false, false};
